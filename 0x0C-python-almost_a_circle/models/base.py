...
class Base:
    ...
    def save_to_file(cls, list_objs):
        """ Method that writes the JSON serialization 
            of a list objects to a file.
        Args:
    ...
    def from_json_string(json_string):
        """Method that returns deserialization a JSON string
        Args:
    ...
    def draw(list_rectangles, list_squares):
        """Method that draws the Rectangle and Square shape with turtle module
        Args:
           list_squares(list): List of square objects to draw
           list_rectangles(list): List of rectangle objects draw
        Return:
           Always nothing
        """
        ...
        t.pen(pencolor="blue", fillcolor="yellow", pensize=4, speed=1)
        ...
        t.pen(pencolor="red", fillcolor="white", pensize=4, speed=0.5)
